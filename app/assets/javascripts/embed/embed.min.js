...
$("#quizme_quizarea").jQuizMe(quiz,options);hideExtraQuizzes();}
...
return types;}
function hideExtraQuizzes(){$('#quizme_quizarea').children('.quiz-el:not(:first)').hide();}
*/
...
function embedQuiz(quiz_json, questions_json, answers_json, div_id){
	var quiz = JSON.parse(quiz_json);
	var questions = JSON.parse(questions_json);
	var answers = JSON.parse(answers_json);
	
	showQuiz(quiz, questions, answers, div_id);
}

function showQuiz(quiz, questions, answers, div_id){
	if (!quiz.description)
		{quiz.description = " ";}
    ...
    $( '#' + div_id ).children('.quizme_quizarea').jQuizMe( quiz, options );
...
/*
function hideExtraQuizzes(){
	$('#quizme_quizarea').children('.quiz-el:not(:first)').hide();
}
*/
