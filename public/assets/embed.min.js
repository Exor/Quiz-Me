...
function showQuiz(quiz, questions, answers){
    ...
    $( "#quizme_quizarea" ).jQuizMe( quiz, options );
...
$("#quizme_embed_btn").click(function(){$("#quizme_embedcode").slideToggle()});

$("#quizme_share_btn").click(function(){$("#quizme_sharebuttons").slideToggle()});