...
$("#quizarea").jQuizMe(quiz,options);hideExtraQuizzes();}
...
return types;}
function hideExtraQuizzes(){$('#quizarea').children('.quiz-el:not(:first)').hide();}
...
function hideExtraQuizzes(){
	$('#quizarea').children('.quiz-el:not(:first)').hide();
}*/