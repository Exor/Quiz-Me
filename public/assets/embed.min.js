...
function loadQuiz(){showQuiz(gon.quiz,gon.questions,gon.answers);}
function showQuiz(quiz,questions,answers){var options
quiz=createQuizObject(questions);options=[];for(var i=0;i<questions.length;i++)
...
options={allRandom:false,help:quiz.help_text,intro:quiz.description,review:quiz.allow_review,showAns:quiz.show_answer,showAnsInfo:quiz.show_explaination,title:quiz.name,disableRestart:!quiz.allow_restart,disableDelete:!quiz.allow_delete}
